...
public class CartServiceImpl implements CartService {
    ...
    public boolean addItemToCart(@RequestParam("userId") String userId,
        ...
        String shopcartJson = redisOperator.get(BaseController.FOODIE_SHOPCART + ":" + userId);
        ...
        // 覆盖现有redis中的购物车
        redisOperator.set(BaseController.FOODIE_SHOPCART + ":" + userId, JsonUtils.objectToJson(shopcartList));
    ...
    public boolean clearCart(@RequestParam("userId") String userId) {
        redisOperator.del(BaseController.FOODIE_SHOPCART + ":" + userId);
        return true;
    }
}
